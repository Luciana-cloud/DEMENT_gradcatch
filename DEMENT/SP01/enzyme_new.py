...
class Enzyme():
    ...
    def __init__(self,runtime,parameters,substrate_index):
        ...
        self.Vmax0_min          = parameters.loc['Vmax0_min',1]             # Minimum Arrhenius constant for enzymes
        self.Vmax0_max          = parameters.loc['Vmax0_max',1]             # Maximum Arrhenius constant for enzymes
        self.Uptake_Vmax0_min   = parameters.loc['Uptake_Vmax0_min',1]      # Minimum Arrhenius constant for uptake
        self.Uptake_Vmax0_max   = parameters.loc['Uptake_Vmax0_max',1]      # Maximum Arrhenius constant for uptake
    ...
    def enzyme_Vmax(self,ReqEnz):
        ...
        Parameters:
          ...
          Vmax0_min:     1e+07  (mg substrate mg-1 enzyme day-1); Minimum Arrhenius constant for enzymes
          Vmax0_max:     1e+08 (mg substrate mg-1 enzyme day-1); Maximum Arrhenius constant for enzymes
    ...
    def enzyme_uptake_Vmax(self,Uptake_ReqEnz):
        ...
        Parameters:
            ...
            Uptake_Vmax0_min: 1e+07	(mg substrate mg-1 substrate day-1)	Minimum Arrhenius constant for uptake
            Uptake_Vmax0_max: 1e+08 (mg substrate mg-1 substrate day-1)	Maximum Arrhenius constant for uptake
            Specif_factor:    default 1; Efficiency-specificity 
        Return:
