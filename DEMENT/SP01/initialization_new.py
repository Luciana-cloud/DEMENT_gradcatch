...
def initialize_data(runtime_parameters):
    ...
    parameters      = pd.read_csv('parameters_orig.csv',         header=None, index_col=0).astype('float32')   # parameters
    substrates_init = pd.read_csv('initial_substrates_orig.csv', header=0,    index_col=0).astype('float32')   # initial substrates
    sub_mon_input   = pd.read_csv('sub_mon_inputs_orig.csv',     header=0,    index_col=0).astype('float32')   # inputs of substrates and monomers
    Ea_input        = pd.read_csv("enzyme_ea_orig.csv",          header=0,    index_col=0).astype('float32')   # enzyme activation energy
